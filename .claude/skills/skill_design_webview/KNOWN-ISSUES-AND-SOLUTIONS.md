...
**Reference:**
- `.claude/troubleshooting/resolutions/webview-member-order-crash.md`
...
**Reference:**
- `.claude/troubleshooting/resolutions/webview-juce8-api-changes.md`
...
**Reference:**
- `.claude/troubleshooting/resolutions/webview-black-screen-resources.md`
...
### Skills
- **`.claude/skills/skill_design_webview/SKILL.md`**
...
- **`.claude/skills/skill_design_webview/KNOWN-ISSUES-AND-SOLUTIONS.md`** ⭐
  - This file
  - Quick reference for common issues

### Troubleshooting
- **`.claude/troubleshooting/known-issues.yaml`**
...
2. **Then, search** `.claude/troubleshooting/known-issues.yaml`
